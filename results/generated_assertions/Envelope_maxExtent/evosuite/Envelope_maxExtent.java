...
public class Envelope {
    ...
    public double maxExtent() {
        ...
        assert ((eq(this.minx, old_this_minx_1)) && (eq(this.maxx, old_this_maxx_1)) && (eq(this.miny, old_this_miny_1)) && (eq(this.maxy, old_this_maxy_1)) && (lte(this.minx, this.maxx)) && (lte(this.miny, this.maxy)) && lt(this.minx, result) && lt(this.maxx, result) && lt(this.miny, result) && ne(this.maxy, result));
        return result;
    }
