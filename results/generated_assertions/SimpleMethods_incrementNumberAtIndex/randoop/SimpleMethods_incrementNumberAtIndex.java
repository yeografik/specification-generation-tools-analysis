...
public class SimpleMethods {
    ...
    public void incrementNumberAtIndex(int[] intArray, int ind) {
        ...
        assert ((lexGT(intArray, old_intArray)) && (pairwiseGTE(intArray, old_intArray)) && (old_ind <= size(intArray)-1) && (getElement_int(intArray, old_ind) - (getElement_int(old_intArray, old_ind)) - 1 == 0));
        ;
    }
