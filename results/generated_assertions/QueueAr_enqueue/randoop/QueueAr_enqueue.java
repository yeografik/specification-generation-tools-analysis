...
public class QueueAr {
    ...
    public void enqueue(Object x) throws Overflow {
        //invalid pre: (daikon.Quant.getElement_Object(this.theArray, this.front) == daikon.Quant.getElement_Object(this.theArray, this.back)) && (this.currentSize == 0 || this.currentSize == 1 || this.currentSize == 2) && (this.front == 0 || this.front == 1) && (this.theArray.getClass().getName() != x.getClass().getName()) && 
        if (!((this.back >= 0) && (size(this.theArray) >= 1) && (this.currentSize <= size(this.theArray) - 1) && (this.front <= size(this.theArray) - 1) && (this.theArray != null) && (this.theArray.getClass().getName() == java.lang.Object[].class.getName()) && (this.currentSize >= 0) && (this.front >= 0) && (this.back >= -1) && (this.currentSize <= size(this.theArray)) && (this.front <= size(this.theArray)) && (this.back <= size(this.theArray) - 1))) {
            return;
        }
        ...
        theArray[back] = x;
        currentSize++;
        assert ((this.theArray == old_this_theArray) && (this.theArray.getClass().getName() == old_this) && (this.front == old_this_front) && (old_x == getElement_Object(this.theArray, this.back)) && (size(this.theArray) == size(old_this_theArray_1)) && (getElement_Object(this.theArray, this.currentSize-1) == getElement_Object(this.theArray, old_this_currentSize)) && (getElement_Object(old_this_theArray_1, this.currentSize-1) == getElement_Object(old_this_theArray_1, old_this_currentSize)) && (this.currentSize == 1 || this.currentSize == 2 || this.currentSize == 3) && (this.front == 0 || this.front == 1) && (this.back == 0 || this.back == 1 || this.back == 2) && (size(this.theArray) >= 1) && (getElement_Object(old_this_theArray_1, this.back) == null) && (this.theArray.getClass().getName() != old_x_1) && (memberOf(old_x_1 , typeArray(this.theArray) )) && (this.currentSize >= this.front) && (this.currentSize >= this.back) && (this.currentSize > old_this_currentSize) && (this.front <= this.back) && (this.front <= size(this.theArray)-1) && (this.back >= old_this_currentSize) && (old_this_currentSize <= size(this.theArray)-1) && (old_this_back <= size(this.theArray)-1) && (this.currentSize + this.front - this.back - 1 == 0) && (this.front - this.back + old_this_currentSize == 0) && (this.theArray != null) && (this.theArray.getClass().getName() == java.lang.Object[].class.getName()) && (this.currentSize >= 0) && (this.front >= 0) && (this.back >= -1) && (this.currentSize <= size(this.theArray)) && (this.front <= size(this.theArray)) && (this.back <= size(this.theArray)-1));
        ;
    }
