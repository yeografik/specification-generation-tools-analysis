...
public class QueueAr {
    ...
    public void makeEmpty() {
        //invalid pre: (this.currentSize == this.front) && (this.back == daikon.Quant.size(this.theArray)-1) && (daikon.Quant.getElement_Object(this.theArray, this.currentSize) == daikon.Quant.getElement_Object(this.theArray, this.back)) && (daikon.Quant.getElement_Object(this.theArray, this.currentSize) == daikon.Quant.getElement_Object(this.theArray, this.back-1)) && (daikon.Quant.eltsEqual(this.theArray, null)) && (daikon.Quant.pairwiseEqual(daikon.Quant.typeArray(this.theArray), new String[] { null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null })) && (daikon.Quant.eltsEqual(daikon.Quant.typeArray(this.theArray), null)) && (this.currentSize == 0) && (daikon.Quant.size(this.theArray) == 32) && (daikon.Quant.eltsEqual(this.theArray, daikon.Quant.getElement_Object(this.theArray, this.currentSize))) && (daikon.Quant.getElement_Object(this.theArray, this.front) == daikon.Quant.getElement_Object(this.theArray, this.back)) && (this.currentSize == 0 || this.currentSize == 1 || this.currentSize == 2) && (this.front == 0 || this.front == 1 || this.front == 2) && 
        if (!((this != null) && (this.theArray != null) && (this.theArray != null) && (this.theArray.getClass().getName() == java.lang.Object[].class.getName()) && (this.back >= 0) && (size(this.theArray) >= 1) && (this.currentSize <= size(this.theArray)) && (this.front <= size(this.theArray)-1) && (this.back <= size(this.theArray)-1))) {
            return;
        }
        ;
