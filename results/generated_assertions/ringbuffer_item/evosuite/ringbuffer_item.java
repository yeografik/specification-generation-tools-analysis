...
public class RingBuffer<G> {
     ...
     */
    public Object item() {
        //invalid pre: (daikon.Quant.pairwiseEqual(daikon.Quant.typeArray(this.data), new String[] { null, null }) || daikon.Quant.pairwiseEqual(daikon.Quant.typeArray(this.data), new String[] { null, "java.lang.Integer" })) && (this.start == 1) && (this.free == 2) && (this.capacity_ == 225 || this.capacity_ == 278) && (daikon.Quant.size(this.data) == 2) && (this.start == 1 || this.start == 2 || this.start == 3) && (this.free == 1 || this.free == 2 || this.free == 3) && 
        ...
        assert ((this.data == old_this_data) && (pairwiseEqual(this.data, old_this_data_1)) && (this.start == old_this_start) && (this.free == old_this_free) && (this.capacity_ == old_this_capacity_) && (pairwiseEqual(typeArray(this.data), new String[] { null, null }) || pairwiseEqual(typeArray(this.data), new String[] { null, "java.lang.Integer" })) && (this.start == 1) && (this.free == 2) && (this.capacity_ == 225 || this.capacity_ == 278) && (result.getClass().getName() == java.lang.Integer.class.getName()) && (size(this.data) == 2) && (memberOf(result.getClass().getName(), typeArray(this.data))) && (this.data != null) && (this.start == 1 || this.start == 2 || this.start == 3) && (this.free == 1 || this.free == 2 || this.free == 3) && (this.capacity_ >= 1) && (size(this.data) >= 1));
        // ensure
