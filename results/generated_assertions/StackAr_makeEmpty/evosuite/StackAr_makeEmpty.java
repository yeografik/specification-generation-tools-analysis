...
public class StackAr {
    ...
    public void makeEmpty() {
        //invalid pre: (this.topOfStack == daikon.Quant.size(this.theArray)-1) && (daikon.Quant.eltsNotEqual(this.theArray, null)) && (daikon.Quant.pairwiseEqual(daikon.Quant.typeArray(this.theArray), new String[] { "java.lang.String" })) && (daikon.Quant.eltsEqual(daikon.Quant.typeArray(this.theArray), "java.lang.String")) && (daikon.Quant.size(this.theArray) == 1) && (daikon.Quant.eltsEqual(this.theArray, daikon.Quant.getElement_Object(this.theArray, this.topOfStack))) && (this.topOfStack == -1 || this.topOfStack == 0 || this.topOfStack == 1) && 
        ...
        topOfStack = -1;
        assert ((this.theArray == old_this_theArray) && (this.theArray.getClass().getName() == old_this) && (old_this_topOfStack == size(this.theArray)-1) && (size(this.theArray) == size(old_this_theArray_1)) && (this.theArray != null) && (eltsEqual(this.theArray, null)) && (pairwiseEqual(typeArray(this.theArray), new String[] { null })) && (eltsEqual(typeArray(this.theArray), null)) && (this.topOfStack == -1) && (size(this.theArray) == 1) && (eltsEqual(this.theArray, getElement_Object(this.theArray, old_this_topOfStack))) && (this.theArray != null) && (this.theArray.getClass().getName() == java.lang.Object[].class.getName()) && (this.topOfStack == -1 || this.topOfStack == 0 || this.topOfStack == 1) && (this.topOfStack <= size(this.theArray)-1));
        ;
    }
