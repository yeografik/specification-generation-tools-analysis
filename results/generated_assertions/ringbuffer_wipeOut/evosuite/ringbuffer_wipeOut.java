...
public class RingBuffer<G> {
     ...
     */
    public void wipeOut() {
        //invalid pre: (daikon.Quant.pairwiseEqual(daikon.Quant.typeArray(this.data), new String[] { null, "java.lang.String" }) || daikon.Quant.pairwiseEqual(daikon.Quant.typeArray(this.data), new String[] { null, "java.lang.String", "java.lang.String" })) && (this.start == 1 || this.start == 2) && (this.free == 1 || this.free == 2) && (this.capacity_ == 1) && (daikon.Quant.size(this.data) == 2 || daikon.Quant.size(this.data) == 3) && (this.start == 1 || this.start == 2 || this.start == 3) && (this.free == 1 || this.free == 2 || this.free == 3) && 
        ...
        // modify_model ("sequence", Current)
        start = free;
        assert ((this.data == old_this_data) && (pairwiseEqual(this.data, old_this_data_1)) && (this.start == this.free) && (this.start == old_this_free) && (this.capacity_ == old_this_capacity_) && (pairwiseEqual(typeArray(this.data), new String[] { null, "java.lang.String" }) || pairwiseEqual(typeArray(this.data), new String[] { null, "java.lang.String", "java.lang.String" })) && (this.start == 1 || this.start == 2) && (this.capacity_ == 1) && (size(this.data) == 2 || size(this.data) == 3) && (this.data != null) && (this.start == 1 || this.start == 2 || this.start == 3) && (this.free == 1 || this.free == 2 || this.free == 3) && (this.capacity_ >= 1) && (size(this.data) >= 1));
        // ensure
        // empty: is_empty
