...
public class RingBuffer<G> {
    ...
    public void extend(G a_value) {
        //invalid pre: (a_value.getClass().getName() == java.lang.String.class.getName()) && (this.start <= this.free) && 
        ...
        if (free == dataCount())
            ...
            free = free + 1;
        assert ((this.data == old_this_data) && (this.start == old_this_start) && (this.capacity_ == old_this_capacity_) && (size(this.data) - 1 == size(old_this_data_1)) && (size(this.data) >= 2) && (memberOf(old_a_value, typeArray(this.data))) && (this.start != this.free) && (this.start <= old_this_free) && (this.free != old_this_free) && (this.data != null) && (this.start >= 1) && (this.free >= 1) && (this.capacity_ >= 1) && (size(this.data) >= 1));
        // ensure
