...
public class MyMap<K, V> {
     ...
     */
    public int count() {
        //invalid pre: (daikon.Quant.size(this.keys) == 0 || daikon.Quant.size(this.keys) == 1 || daikon.Quant.size(this.keys) == 2) && (daikon.Quant.size(this.data) == 0 || daikon.Quant.size(this.data) == 1 || daikon.Quant.size(this.data) == 2) && (daikon.Quant.eltsNotEqual(this.keys, null)) && 
        ...
        assert ((this.keys == old_this_keys) && (pairwiseEqualK(this.keys, old_this_keys_1)) && (this.data == old_this_data) && (pairwiseEqualV(this.data, old_this_data_1)) && (result == 0 || result == 1 || result == 2) && (this.keys != null) && (eltsNotEqual(this.keys, null)) && (this.data != null) && (size(this.keys) == 0 || size(this.keys) == 1 || size(this.keys) == 2) && (size(this.data) == 0 || size(this.data) == 1 || size(this.data) == 2));
        return result;
    }
