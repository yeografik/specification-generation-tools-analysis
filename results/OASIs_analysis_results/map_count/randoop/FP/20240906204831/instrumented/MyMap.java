...
public class MyMap<K, V> {
    ...
    public int count() {
        ...
        if (!(((this.keys == old_this_keys) && (pairwiseEqualK(this.keys, old_this_keys_1)) && (this.data == old_this_data) && (pairwiseEqualV(this.data, old_this_data_1)) && (result >= 0) && (this.keys != null) && (this.data != null)))) {
            int mm = 2;
            assert (3 > mm);
        }
        return result;
