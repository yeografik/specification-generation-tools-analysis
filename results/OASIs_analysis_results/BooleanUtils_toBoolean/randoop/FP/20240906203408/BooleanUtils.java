...
public class BooleanUtils {
    ...
    public static boolean toBoolean(final Integer value, final Integer trueValue, final Integer falseValue) {
        //invalid pre: (value != null) && (trueValue != null) && (falseValue != null) &&
        Integer old_falseValue = falseValue;
        Integer old_trueValue = trueValue;
        Integer old_value = value;
        ...
        assert (((old_value == old_falseValue) || !(result == false)) && ((old_value == old_trueValue) || !(result == true)));
        return result;
    }
}
