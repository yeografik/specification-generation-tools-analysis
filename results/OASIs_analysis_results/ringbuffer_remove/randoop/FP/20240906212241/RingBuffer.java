...
public class RingBuffer<G> {
     ...
     */
    public void remove() {
        //invalid pre: (this.start == 1 || this.start == 2 || this.start == 3) && (this.capacity_ == 8 || this.capacity_ == 10 || this.capacity_ == 100) && (this.start < this.free) && (this.start < this.capacity_) && (this.free < this.capacity_) && 
        if (!((this.data != null) && (size(this.data) >= 1) && (this.start >= 1) && (this.free >= 1) && (this.capacity_ >= 1))) {
            return;
        }
        ...
        if (start == dataCount())
            ...
            start++;
        assert ((this.data == old_this_data) && (pairwiseEqual(this.data, old_this_data_1)) && (this.free == old_this_free) && (this.capacity_ == old_this_capacity_) && (this.start == 2 || this.start == 3 || this.start == 4) && (this.capacity_ == 8 || this.capacity_ == 10 || this.capacity_ == 100) && (this.start <= this.free) && (this.start < this.capacity_) && (this.start > old_this_start) && (this.free < this.capacity_) && (this.free > old_this_start) && (this.capacity_ > old_this_start) && (this.data != null) && (this.start >= 1) && (this.free >= 1) && (this.capacity_ >= 1) && (size(this.data) >= 1));
        // ensure
