...
public class StackAr {
    ...
    public void push(Object x) throws Overflow {
        //invalid pre: (this.theArray.getClass().getName() != x.getClass().getName()) && 
        if (!((size(this.theArray) >= 1) && (this.topOfStack < size(this.theArray) - 1) && (this.theArray != null) && (this.theArray.getClass().getName() == java.lang.Object[].class.getName()) && (this.topOfStack >= -1) && (this.topOfStack <= size(this.theArray) - 1))) {
            return;
        }
        ...
        if (!(((this.theArray == old_this_theArray) && (this.theArray.getClass().getName() == old_this) && (old_x == getElement_Object(this.theArray, this.topOfStack)) && (size(this.theArray) == size(old_this_theArray_1)) && (this.topOfStack >= 0) && (size(this.theArray) >= 1) && (getElement_Object(old_this_theArray_1, this.topOfStack) == null) && (this.theArray.getClass().getName() != old_x_1) && (memberOf(old_x_1, typeArray(this.theArray))) && (this.topOfStack - old_this_topOfStack - 1 == 0) && (old_this_topOfStack < size(this.theArray) - 1) && (this.theArray != null) && (this.theArray.getClass().getName() == java.lang.Object[].class.getName()) && (this.topOfStack >= -1) && (this.topOfStack <= size(this.theArray) - 1)))) {
            int mm = 2;
            assert (3 > mm);
        }
        ;
