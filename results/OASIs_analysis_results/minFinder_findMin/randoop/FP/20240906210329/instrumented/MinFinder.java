...
public class MinFinder {
    ...
    public T findMin() {
        ...
        T result = _var811;
        if (!(((this._var88 == old_this__var88) && (pairwiseEqual(this._var88, old_this__var88_1)) && (this._var811 == result) && (this._var811.val == result.val) && (result == old_this__var811) && (result.val == old_this_val) && (this._var88 != null)))) {
            int mm = 2;
            assert (3 > mm);
        }
        return result;
