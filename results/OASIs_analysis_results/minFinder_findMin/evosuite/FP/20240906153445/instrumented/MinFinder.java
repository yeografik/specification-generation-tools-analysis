...
public class MinFinder {
    ...
    public T findMin() {
        ...
        T result = _var811;
        if (!(((this._var88 == old_this__var88) && (pairwiseEqual(this._var88, old_this__var88_1)) && (this._var811 == result) && (this._var811.val == result.val) && (result == old_this__var811) && (result.val == old_this_val) && (pairwiseEqual(typeArray(this._var88), new String[] {}) || pairwiseEqual(typeArray(this._var88), new String[] { "examples.MinFinder.T" })) && (eltsEqual(typeArray(this._var88), "examples.MinFinder.T")) && (result.val == -1 || result.val == 0 || result.val == 3111) && (size(this._var88) == 0 || size(this._var88) == 1)))) {
            int mm = 2;
            assert (3 > mm);
        }
        return result;
