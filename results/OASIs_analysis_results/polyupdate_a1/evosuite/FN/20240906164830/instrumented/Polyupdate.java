...
public class Polyupdate implements java.io.Serializable {
  ...
  */
    ...
    public void a1(int y) {
        //invalid pre: (this._var23 == -736 || this._var23 == 0) && (this._var426 == -736 || this._var426 == 0) && 
        int old_this_var426 = this._var426;
        int old_y = y;
        ...
        //instrumentation
        map0.put("assert_result0", (this._var426 - old_this_var426 - old_y == 0));
        //instrumentation
        ...
        //instrumentation
        map0.put("old_this_var426", old_this_var426);
        //instrumentation
        map0.put("y", y);
        //instrumentation
