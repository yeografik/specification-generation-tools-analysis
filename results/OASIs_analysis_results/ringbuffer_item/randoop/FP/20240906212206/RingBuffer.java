...
public class RingBuffer<G> {
     ...
     */
    public Object item() {
        //invalid pre: (this.start == 1 || this.start == 2 || this.start == 3) && (this.free >= 2) && (this.start < this.free) && (this.start <= this.capacity_) && (this.free != this.capacity_) && 
        if (!((size(this.data) >= 1) && (size(this.data) >= 2) && (this.data != null) && (this.start >= 1) && (this.free >= 1) && (this.capacity_ >= 1))) {
            return null;
        }
        ...
        assert ((this.data == old_this_data) && (pairwiseEqual(this.data, old_this_data_1)) && (this.start == old_this_start) && (this.free == old_this_free) && (this.capacity_ == old_this_capacity_) && (this.start == 1 || this.start == 2 || this.start == 3) && (this.free >= 2) && (result.getClass().getName() == java.lang.String.class.getName()) && (size(this.data) >= 2) && (memberOf(result.getClass().getName(), typeArray(this.data))) && (this.start < this.free) && (this.start <= this.capacity_) && (this.free != this.capacity_) && (this.data != null) && (this.start >= 1) && (this.free >= 1) && (this.capacity_ >= 1) && (size(this.data) >= 1));
        // ensure
