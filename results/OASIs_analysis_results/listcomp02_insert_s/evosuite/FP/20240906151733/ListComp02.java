...
public class ListComp02 {
    ...
    public void insert_s(S s) {
        //invalid pre: (daikon.Quant.eltsNotEqual(this._var49, null)) && (daikon.Quant.eltsEqual(daikon.Quant.typeArray(this._var49), "examples.R")) && (daikon.Quant.pairwiseEqual(daikon.Quant.typeArray(this._var49), new String[] {  }) || daikon.Quant.pairwiseEqual(daikon.Quant.typeArray(this._var49), new String[] { "examples.R" })) && (daikon.Quant.pairwiseEqual(daikon.Quant.typeArray(this._var50), new String[] {  })) && (s.getB().toString().equals(";aeodkf[6j'") || s.getB().toString().equals("JZJ#a%+7cdh") || s.getB().toString().equals("oSU|O_z$_}a")) && (daikon.Quant.eltsNotEqual(this._var50, null)) && (daikon.Quant.eltsEqual(daikon.Quant.typeArray(this._var50), "examples.S")) && (daikon.Quant.pairwiseEqual(daikon.Quant.typeArray(this._var50), new String[] {  }) || daikon.Quant.pairwiseEqual(daikon.Quant.typeArray(this._var50), new String[] { "examples.S" })) && (daikon.Quant.size(this._var49) == 0 || daikon.Quant.size(this._var49) == 1) && (daikon.Quant.size(this._var50) == 0 || daikon.Quant.size(this._var50) == 1)
