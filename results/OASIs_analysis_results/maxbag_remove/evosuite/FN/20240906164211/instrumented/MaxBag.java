...
public class MaxBag {
    ...
    public void remove(Integer x) {
        //invalid pre: (daikon.Quant.eltsLTE(this._var4384._1, x)) && 
        if (!((this._var4384._0 == this._var5992) && (this._var4384._0 != null) && (this._var4384._1 != null) && (this._var4384._1.getClass().getName() == java.lang.Integer[].class.getName()) && (eltsEqual(typeArray(this._var66253), "java.lang.Integer")))) {
            //instrumentation
            return;
        }
        ...
        Integer[] old_this_1 = this._var4384._1;
        ...
        //instrumentation
        map0.put("assert_result0", ((this._var721 == old_this__var721) && (this._var1457 == old_this__var1457) && (this._var4384 == old_this__var4384) && (this._var4384._1 == old_this_1) && (this._var4384._1.getClass().getName() == old_this) && (this._var66253 == old_this__var66253) && (size(this._var4384._1) == size(old_Type328393._1)) && callEltsLT(this._var4384._1, this._var5992) && callLexLTE(this._var4384._1, old_Type328393._1) && callEltsLTE(this._var4384._1, old_x) && callEltsLT(old_Type328393._1, this._var5992) && (size(this._var66253) <= size(old_this__var66253_1)) && (size(this._var66253) >= size(old_this__var66253_1) - 1) && (size(this._var66253) - 1 <= size(old_this__var66253_1) - 1) && (this._var4384._0 == this._var5992) && (this._var4384._0 != null) && (this._var4384._1 != null) && (this._var4384._1.getClass().getName() == java.lang.Integer[].class.getName()) && (eltsEqual(typeArray(this._var66253), "java.lang.Integer"))));
        //instrumentation
    ...
    private boolean callLexLTE(Integer[] a1, Integer[] a2) {
        int[] b1 = toIntArray(a1);
        int[] b2 = toIntArray(a2);
        return lexLTE(b1, b2);
    }
    ...
    private int[] toIntArray(Integer[] arr) {
        ...
        int i = 0;
        for (Integer value : arr) newArr[i++] = value.intValue();
        return newArr;
    }

    private boolean lexLTE(int[] seq1, int[] seq2) {
        if (seq1 == null) {
            return false;
        }
        if (seq2 == null) {
    ...
    private boolean callEltsLT(Integer[] a1, Integer a2) {
        int[] b1 = toIntArray(a1);
        int b2 = a2.intValue();
        return eltsLT(b1, b2);
    }

    private boolean eltsLT(int[] arr, int elt) {
        if (arr == null) {
            return false;
        }
        for (int i = 0; i < arr.length; i++) {
    ...
    private boolean callEltsLTE(Integer[] a1, Integer a2) {
        int[] b1 = toIntArray(a1);
        int b2 = a2.intValue();
        return eltsLTE(b1, b2);
    }

    private boolean eltsLTE(int[] arr, int elt) {
        if (arr == null) {
            return false;
        }
        for (int i = 0; i < arr.length; i++) {
