...
public class RingBuffer<G> {
    ...
    public void wipeOut() {
        ...
        start = free;
        assert ((this.data == old_this_data) && (pairwiseEqual(this.data, old_this_data_1)) && (this.start == this.free) && (this.start == old_this_free) && (this.capacity_ == old_this_capacity_) && (this.start >= old_this_start) && (this.data != null) && (this.start >= 1) && (this.free >= 1) && (this.capacity_ >= 1) && (size(this.data) >= 1) && (this.start <= this.free));
        // ensure
        // empty: is_empty
