...
public class RingBuffer<G> {
    ...
    public int count() {
        ...
        if (!(((this.data == old_this_data) && (pairwiseEqual(this.data, old_this_data_1)) && (this.start == old_this_start) && (this.free == old_this_free) && (this.capacity_ == old_this_capacity_) && (result >= 0) && (this.free > result) && (this.capacity_ >= result) && (this.data != null) && (this.start >= 1) && (this.free >= 1) && (this.capacity_ >= 1) && (size(this.data) >= 1) && (this.start <= this.free)))) {
            int mm = 2;
            assert (3 > mm);
        }
        return result;
