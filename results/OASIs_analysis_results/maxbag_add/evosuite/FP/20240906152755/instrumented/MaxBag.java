...
public class MaxBag {
    ...
    public void add(Integer x) {
        //invalid pre: (daikon.Quant.size(this._var4384._1) == 0 || daikon.Quant.size(this._var4384._1) == 1 || daikon.Quant.size(this._var4384._1) == 3) &&
        ...
        if (!(((this._var721 == old_this__var721) && (this._var4384 == old_this__var4384) && (this._var4384._1.getClass().getName() == old_this) && (this._var66253 == old_this__var66253) && (size(this._var66253) - 1 == size(old_this__var66253_1)) && (this._var1457 != null) && (size(this._var4384._1) == 1 || size(this._var4384._1) == 3 || size(this._var4384._1) == 7) && (memberOf(this._var587, this._var4384._1)) && (memberOf(old_x, this._var4384._1)) && (size(this._var4384._1) >= size(old_Type328393._1)) && (size(this._var4384._1) - 1 >= size(old_Type328393._1) - 1) && (this._var4384._0 == this._var5992) && (this._var4384._0 != null) && (this._var4384._1 != null) && (this._var4384._1.getClass().getName() == java.lang.Integer[].class.getName())))) {
            int mm = 2;
            assert (3 > mm);
        }
        ;
    ...
    private boolean callLexGT(Integer[] a1, Integer[] a2) {
        int[] b1 = toIntArray(a1);
        int[] b2 = toIntArray(a2);
        return lexGT(b1, b2);
    }

    private boolean callLexGTE(Integer[] a1, Integer[] a2) {
        int[] b1 = toIntArray(a1);
        int[] b2 = toIntArray(a2);
        return lexGTE(b1, b2);
    }
    ...
    private boolean lexGTE(int[] seq1, int[] seq2) {
        if (seq1 == null) {
            return false;
        }
        if (seq2 == null) {
