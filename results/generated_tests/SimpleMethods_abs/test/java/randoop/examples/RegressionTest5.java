...
public class RegressionTest5 {
    ...
    public void test2542() throws Throwable {
        ...
        int int28 = simpleMethods0.abs(4);
    ...
    public void test2664() throws Throwable {
        ...
        int int36 = simpleMethods0.abs(100);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + 0 + "'", int2 == 0);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 2 + "'", int4 == 2);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 9 + "'", int6 == 9);
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 0 + "'", int8 == 0);
    ...
    public void test2693() throws Throwable {
        ...
        int int24 = simpleMethods0.abs(1);
        int int26 = simpleMethods0.abs(0);
        int int28 = simpleMethods0.abs(32);
    ...
    public void test2718() throws Throwable {
        ...
        int int28 = simpleMethods0.abs((int) (short) 100);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + 0 + "'", int2 == 0);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 2 + "'", int4 == 2);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 9 + "'", int6 == 9);
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 0 + "'", int8 == 0);
    ...
    public void test2813() throws Throwable {
        ...
        int int28 = simpleMethods0.abs(35);
        int int30 = simpleMethods0.abs((int) (byte) 0);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + 0 + "'", int2 == 0);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 2 + "'", int4 == 2);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 9 + "'", int6 == 9);
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 0 + "'", int8 == 0);
    ...
    public void test2836() throws Throwable {
        ...
        int int24 = simpleMethods0.abs(100);
        int int26 = simpleMethods0.abs(8);
        int int28 = simpleMethods0.abs((int) (byte) 1);
    ...
    public void test2896() throws Throwable {
        ...
        int int32 = simpleMethods0.abs((-4));
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + 0 + "'", int2 == 0);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 2 + "'", int4 == 2);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 9 + "'", int6 == 9);
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 0 + "'", int8 == 0);
